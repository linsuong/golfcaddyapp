...
# future features:
- use LLM to sort out club distances, shot shaping, etc.
- factor in slopes on the course (slope API or something)
- add in slopes (ball below feet, above feet, etc.) - reminds you how to hit the ball, like a coach
